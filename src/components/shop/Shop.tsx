            ...
            <div className="bb-shop-pro-inner">
              <Row className="mb-minus-24">
                ...
                {!data?.data ? (<div><Spinner /></div>) : (
                  <Fade triggerOnce direction='up' duration={1000} delay={200} className={`col-md-${col} ${lg} col-lg-4 col-6 mb-24 bb-product-box pro-bb-content ${isGridView ? "width-100 pro-bb-content" : ""}`}>
